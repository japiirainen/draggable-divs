...
function BigNumber() {
   ...
   return <div className="bigNumber">{total}</div>
}
   ...
   return (
      ...
      >
         <div ref={ref} className="box">
            <p className="cord">x: {box.x}</p>
            <p className="cord">y: {box.y}</p>
         </div>
      </Draggable>
   )
})
...
function Header() {
   return <div className="header">add 2 or more divs and start dragging!</div>
}
